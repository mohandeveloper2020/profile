...
export const technicalSkillSections = [
  {
...
export const visionStatements = [
  ...
  "Aspiring to take on a strategic role, applying my UI/UX expertise, leadership, and mentoring skills to drive digital transformation while continuously upskilling in emerging AI technologies and managerial disciplines.",
] as const;